	...
	public static void main(String[] args) {
		...
		try(Scanner sc = new Scanner(System.in)){
			...
			while(!exit) {
				...
				switch(sc.nextInt()) {
				case 1:
					System.out.println("Enter Your Details: \nFirst Name, Last Name,Email,Password ,Registration Amount,Date Of Birth,Subscription plan");
					System.out.println("Plan Available: SILVER(1000), GOLD(2000), DIAMOND(5000), PLATINUM(10000)");
						customers.add(allInputCheck(sc.next(),sc.next(),sc.next(),sc.next(),sc.nextDouble(),sc.next(),sc.next(),customers));
					break;
