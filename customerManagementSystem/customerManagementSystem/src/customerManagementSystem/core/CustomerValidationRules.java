...
//	public static void strongPassword(String password,List<Customer> customers) throws CustomerExceptionHandling {
...
////	        }
//		if(newCustomer.getPassword().matches(regex)) {
//			System.out.println("Successfully registered");
//		}else {
...
//	}
	...
	public static Customer allInputCheck(String first_name, String last_name, String email, String password,
			double registrationAmount, String dob, String plan, List<Customer> customers)
			throws CustomerExceptionHandling, IllegalArgumentException {
		checkDups(email, customers);
		//strongPassword(password,customers);
		...
		return new Customer(first_name, last_name, email, password, registrationAmount, validDOB, validPlan);
	}
